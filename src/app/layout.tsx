    ...
    <html lang="en">
      <body className={jockey.className}>
        ...
        <main className="fixed w-full h-full flex items-center mx-auto overflow-hidden z-10">
          <div className="relative pt-12 w-5/6 max-w-3xl h-[85%] md:h-[88%] text-white mx-auto pb-20 mt-5 p-6 rounded-xl bg-zinc-800 shadow-lg overflow-y-auto overflow-x-hidden">
            {children}
